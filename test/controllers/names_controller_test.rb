...
class NamesControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create name' do
    assert_difference('Name.count') do
      post names_url,
           params: { name: { birthYear: @name.birthYear, deathYear: @name.deathYear, knownForTitles: @name.knownForTitles, nconst: @name.nconst, primaryName: @name.primaryName, primaryProfession: @name.primaryProfession } }, as: :json
    end
